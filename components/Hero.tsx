...
const HERO_SLIDES = [
  ...
  '/hero-slide/04-trang-san-tmdt.jpg',
  '/hero-slide/05-livestream-ban-hang.jpg',
  '/hero-slide/06-dong-goi-don-hang.jpg',
  '/hero-slide/07-quan-ly-danh-muc.jpg',
  '/hero-slide/08-xe-giao-hang-buu-dien.jpg',
  '/hero-slide/09-bieu-do-hieu-suat.jpg',
  '/hero-slide/10-kho-hang.jpg',
  '/hero-slide/11-set-chup-anh-san-pham.jpg',
  '/hero-slide/12-thung-carton-xep-lop.jpg',
  '/hero-slide/13-ho-kinh-doanh-via-he.jpg',
  '/hero-slide/14-shopee-app.jpg',
  '/hero-slide/15-shopee-app-mockup.png',
];
const SLIDE_MS = 4000;
